                   ...
                   {/* Header */}
                    <Box sx={{
                        ...
                        <Typography variant="h6">
                            <img src="https://frontend.tikicdn.com/_desktop-next/static/img/icons/checkout/icon-payment-method-momo.svg" alt="Momo" style={{width: '30px', height: '30px',   position: "relative",  top: "10px" }} />
                            Payment by Momo
                        </Typography>
                        <Button onClick={handleClose}>
                            Change Other Payment Method
                        </Button>
                    </Box>
                    <hr/>
                    <br/>
                    ...
                    <Grid container sx={{
                        ...
                        <Grid container item xs={12} md ={6} sx = {{
                            ...
                            <Grid item xs={12} sm={12}>
                                <Typography variant="h6">Total <b>{formValues.totalPrice}</b></Typography>
                            </Grid>
                        </Grid>
                        {/* Steps  */}
                        <Grid container item xs={12} md ={6}>
                            ...
                            <Grid item xs={12} sm={12}>
                             {
                                time > 30 &&  <Typography variant="h6" sx={{
                                    color: "green"
                                }}>
                                    You can pay in {time} seconds
                                </Typography> 
                             }
                             {
                                time <= 30 && <Typography variant="h6" sx={{
